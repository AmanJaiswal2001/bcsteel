...
const Button = ({buttonName,   onClick}) => {
  return (
    <div className=" w-full  h-14  rounded-2xl cursor-pointer flex  items-center justify-center text-white group overflow-hidden mx-auto sm:mx-0">
    ...
    <button 
         onClick={onClick}
         className="sm:font-medium  w-full  text-center  sm:text-[18px]  font-poppins group-hover:translate-x-1 group-hover:opacity-100 duration-300 relative z-10">{buttonName}</button>
