...
const HotRolledCatgory = ({filters}) => {
  ...
  const coilProducts = Array.isArray(products)
    ? products.filter((p) => {
...
{(
  ...
  <p className="text-sm text-black mb-4 font-poppins font-semibold">
    ...
    <div class="grid w-[90%]  grid-cols-1 m-auto sm:m-0  md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-6  mt-10  place-items-center ">
 {/* <div> */}
